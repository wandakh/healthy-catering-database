...
update menu set kategori_alergen = 'seafood' where id_menu in (2, 3);
...
insert into pemesanan (id_user, id_menu, kategori_waktu, jumlah_porsi, tanggal_pesan, total_harga)
values (1, 1, 'siang', 1, now() - interval 2 day, (select harga_menu from menu where id_menu = 1));
set @v_id_pemesanan_1 = last_insert_id();

insert into jadwal_pengiriman (id_user, id_menu, id_pemesanan, tanggal_hari)
values (1, 1, @v_id_pemesanan_1, curdate() - interval 2 day);
...
insert into pemesanan (id_user, id_menu, kategori_waktu, jumlah_porsi, tanggal_pesan, total_harga)
values (1, 1, 'malam', 1, now() - interval 1 day, (select harga_menu from menu where id_menu = 1));
set @v_id_pemesanan_2 = last_insert_id();

insert into jadwal_pengiriman (id_user, id_menu, id_pemesanan, tanggal_hari)
values (1, 1, @v_id_pemesanan_2, curdate() - interval 1 day);
